...
2. `amplify push`
3. `amplify override <auth|storage|project>` or `amplify update <auth|storage|project>`
4. Answer "y" to migrate your resources
5. `amplify push`
6. Test your app scenarios now with this test environment
